...
function film_maker_lite_scripts() {
	...
	wp_enqueue_style( 'film-maker-lite-fonts', film_maker_lite_fonts_url(), array(), null );
	...
	if(!wp_is_mobile()){
		...
		wp_enqueue_script( 'film-maker-lite-super-custom-scripts', esc_url( get_template_directory_uri() ) . '/assets/js/film-maker-lite-super-custom.js', array('jquery','jquery-superfish'), true);
    }
	...
	wp_enqueue_script( 'film-maker-lite-focus-nav', esc_url( get_template_directory_uri() ) . '/assets/js/focus-nav.js', array('jquery'), true);
